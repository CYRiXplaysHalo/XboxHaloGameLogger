...
# datum array header fields (found by Xbox7887)
...
for player_index in range(player_count):
  player_stats = {}
  player_stats['kills'] = read_s8(player_datum_array_first_element_address + player_index * player_datum_array_element_size +152)
  player_stats['team_kills'] = read_s8(player_datum_array_first_element_address + player_index * player_datum_array_element_size +168)
  player_stats['deaths'] = read_s8(player_datum_array_first_element_address + player_index * player_datum_array_element_size +170)
  player_stats['suicides'] = read_s8(player_datum_array_first_element_address + player_index * player_datum_array_element_size +172)
  player_stats['name'] = t.read(player_datum_array_first_element_address + player_index * player_datum_array_element_size + 4,24).decode("utf-16").split('\x00',1)[0]
  player_stats['index'] = player_index
  player_stat_array.append(player_stats)

while True:
    
  score1_new = read_s8(0x276710) # 0x276710 is location of red team score in team slayer games
  score2_new = read_s8(0x276714) # 0x276714 is location of blue team score in team slayer games
